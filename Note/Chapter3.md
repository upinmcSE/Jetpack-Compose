...
fun DemoClickable(){
    Column(modifier = Modifier
        .padding(24.dp)
        .clickable { /*TODO*/ }) {
        Image(painter = painterResource(id = R.drawable.banner1), contentDescription = null)
        Text("Product")
        Text(text ="Price: $100")
    }
}
...
fun DemoDetectTapGestures(){
    ...
    Column {
        ...
        Text("Tap me", modifier = Modifier.pointerInput(Unit) {
            detectTapGestures(
                onLongPress = { textContent.value = "Long Press" },
                onTap = { textContent.value = "Tap" },
